...
class Property extends Component {
  ...
  render() {
    ...
    return (
      <li {...props}>
        <code className="inline">{value}</code>{details}{children}
      </li>
    );
  }
}
...
class BoolClassProperty extends Component {
  render() {
    ...
    return (
      <ClassProperty value={value + ': bool'} defaults="false" {...props} />
    );
  }
}
  ...
  render() {
    return (
      <div className="page">
        ...
        <h3>Others</h3>
        You can download UMD builds from the
        {' '}
        <a href="https://github.com/PaulLeCam/react-pure/tree/master/dist">
          GitHub repository
        </a>
        .
        <br />
        The components are accessible in the
        {' '}
        <code className="inline">window.ReactPure</code>
        {' '}
        object.
...
var Button = require('react-pure/lib/Button');`
        ...
        <ul>
          ...
          <Property value="href: string" defaults="false">
            ...
            element instead of
            {' '}
            <code className="inline">{'<button>'}</code>
            .
          </Property>
        </ul>
        ...
        <p>
          A Cell is an element of a
          {' '}
          <a href="http://purecss.io/grids/">Pure CSS Grid</a>
          .
        </p>
        <h4>Properties</h4>
        <ul>
          <Property value="size: string" defaults="1">
            adds the
            {' '}
            <code className="inline">{'pure-u-{size}'}</code>
            {' '}
            class.
            <br />
            You can use the
            ...
            , ex:
            {' '}
            <code className="inline">{`<Cell size='1/3'>`}</code>
            .
          </Property>
        ...
        <p>
          Renders a
          {' '}
          <code className="inline">{'<li>'}</code>
          {' '}
          node with the
          {' '}
          <code className="inline">pure-menu-item</code>
          {' '}
          class by default.
        </p>
        <h4>Properties</h4>
